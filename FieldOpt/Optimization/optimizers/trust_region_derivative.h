...
#ifndef TRUSTREGIONDERIVATIVE_H
#define TRUSTREGIONDERIVATIVE_H
 ...
 */
        class TrustRegionDerivative : public Optimizer
        {
        public:
            TrustRegionDerivative(::Utilities::Settings::Optimizer *settings, Case *base_case, ::Model::Properties::VariablePropertyContainer *variables);
